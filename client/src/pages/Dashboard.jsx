      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Scan any GitHub repository for vulnerabilities
            </p>
          </div>
          <Link to="/scan"
            className="flex items-center gap-2 bg-violet-600 text-white
                       px-5 py-2.5 rounded-xl hover:bg-violet-700 transition
                       font-medium text-sm">
        ...
        {scans.length > 0 && (
          <div className="relative mb-6">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2
                               text-gray-500" size={18} />
            <input
              type="text"
              value={search}
              onChange={e => setSearch(e.target.value)}
              placeholder="Search repositories..."
              className="w-full pl-11 pr-4 py-3 bg-gray-900 border border-gray-800
        ...
        {loading ? (
          ...
          <div className="bg-gray-900 rounded-2xl border border-gray-800
            ...
            <Link to="/scan"
              className="inline-flex items-center gap-2 bg-violet-600 text-white
                         px-6 py-2.5 rounded-xl hover:bg-violet-700 transition
                         font-medium text-sm">
          ...
          <div className="bg-gray-900 rounded-2xl border border-gray-800
            ...
            <p className="text-gray-500 text-sm">
              No scans match "<span className="text-white">{search}</span>"
            </p>
          </div>
        ) : (
          <div className="flex flex-col gap-3">
            {filtered.map(scan => (
              ...
              >
                ...
                <div className="flex items-center gap-4 min-w-0">
                  <div className="w-10 h-10 bg-violet-500/10 rounded-xl
